package horonaga.Proje_Ve_Odevler;

import java.util.Scanner;

public class Projem_Market_Programi {
    public static void main(String[] args) {
        ...
        if (liste01 == 0) {
            ...
            System.out.println(urun01 + " : " + kilo01 + " kg x " + (String.format("%.2f", fiyat01)) + " TL           " + (String.format("%.2f", liste01)) + " TL");
        }
        if (liste02 == 0) {
        } else {
            System.out.println(urun02 + " : " + kilo02 + " kg x " + (String.format("%.2f", fiyat02)) + " TL           " + (String.format("%.2f", liste02)) + " TL");
        }
        if (liste03 == 0) {
        } else {
            System.out.println(urun03 + " : " + kilo03 + " kg x " + (String.format("%.2f", fiyat03)) + " TL           " + (String.format("%.2f", liste03)) + " TL");
        }
        if (liste04 == 0) {
        } else {
            System.out.println(urun04 + " : " + kilo04 + " kg x " + (String.format("%.2f", fiyat04)) + " TL           " + (String.format("%.2f", liste04)) + " TL");
        }
        if (liste05 == 0) {
        } else {
            System.out.println(urun05 + " : " + kilo05 + " kg x " + (String.format("%.2f", fiyat05)) + " TL           " + (String.format("%.2f", liste05)) + " TL");
        }
        if (liste06 == 0) {
        } else {
            System.out.println(urun06 + " : " + kilo06 + " kg x " + (String.format("%.2f", fiyat06)) + " TL           " + (String.format("%.2f", liste06)) + " TL");
        }
        if (liste07 == 0) {
        } else {
            System.out.println(urun07 + " : " + kilo07 + " kg x " + (String.format("%.2f", fiyat07)) + " TL           " + (String.format("%.2f", liste07)) + " TL");
        }
        if (liste08 == 0) {
        } else {
            System.out.println(urun08 + " : " + kilo08 + " kg x " + (String.format("%.2f", fiyat08)) + " TL           " + (String.format("%.2f", liste08)) + " TL");
        }
        if (liste09 == 0) {
        } else {
            System.out.println(urun09 + " : " + kilo09 + " kg x " + (String.format("%.2f", fiyat09)) + " TL           " + (String.format("%.2f", liste09)) + " TL");
        }
        if (liste10 == 0) {
        } else {
            System.out.println(urun10 + " : " + kilo10 + " kg x " + (String.format("%.2f", fiyat10)) + " TL           " + (String.format("%.2f", liste10)) + " TL");
        }
